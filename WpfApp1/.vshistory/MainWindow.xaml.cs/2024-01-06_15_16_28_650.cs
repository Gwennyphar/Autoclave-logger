    ...
    public partial class MainWindow : Window
    {
        ...
        private void readFiles(OpenFileDialog openFileDialog)
        {
            ...
            if (openFileDialog.ShowDialog() == true)
            {
                ...
                //wpfListView.SelectedListViewItemCollection selectedItems = ListView1.SelectedItems;


                wpfTextbox.AppendText(File.ReadAllText(wpfListView.Items.ToString(openFileDialog.SafeFileNames) ));
